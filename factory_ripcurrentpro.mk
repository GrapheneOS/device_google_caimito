...
include device/google/caimito/audio/ripcurrentpro/factory-audio-tables.mk

PRODUCT_NAME := factory_ripcurrentpro
PRODUCT_DEVICE := ripcurrentpro
PRODUCT_MODEL := Factory build on RipcurrentPro
